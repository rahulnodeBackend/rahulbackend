                ...
                <div class="header-content-left">
                    ...
                    <div class="main-header-center  d-none d-lg-block header-link">
                        <input type="text" class="form-control" id="typehead" placeholder="Search for results..."
                            autocomplete="off" />
                        <button type="button"  aria-label="button" class="btn pe-1"><i class="fa fa-search" aria-hidden="true"></i></button>
                        <div id="headersearch" class="header-search">
                            <div class="p-3">
                                <div class="">
                                    <p class="fw-semibold text-muted mb-2 fs-13">Recent Searches</p>
                                    <div class="ps-0">
                                        <a  href="javascript:void(0)" class="search-tags"><i class="fa fa-search me-2"></i>People<span></span></a>
                                        <a  href="javascript:void(0)" class="search-tags"><i class="fa fa-search me-2"></i>Pages<span></span></a>
                                        <a  href="javascript:void(0)" class="search-tags"><i class="fa fa-search me-2"></i>Articles<span></span></a>
                                    </div>
                                </div>
                                 <div class="mt-3">
                                    ...
                                    <ul class="ps-0">
                                        <li class="p-1 d-flex align-items-center text-muted mb-3 search-app">
                                            <a class="d-inline-flex align-items-center" href="full-calendar.html"><i class="fa fa-calendar me-2 fs-14 bg-primary-transparent p-2 rounded-circle"></i><span>Calendar</span></a>
                                        </li>
                                        <li class="p-1 d-flex align-items-center text-muted mb-3 search-app">
                                            <a class="d-inline-flex align-items-center" href="mail.html"><i class="fa fa-mail me-2 fs-14 bg-primary-transparent p-2 rounded-circle"></i><span>Mail</span></a>
                                        </li>
                                        <li class="p-1 d-flex align-items-center text-muted mb-3 search-app">
                                            <a class="d-inline-flex align-items-center" href="buttons.html"><i class="fa fa-globe me-2 fs-14 bg-primary-transparent p-2 rounded-circle"></i><span>Buttons</span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="mt-3">
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element header-search d-lg-none d-block">
                        ...
                        <a aria-label="anchor" href="javascript:void(0);" class="header-link" data-bs-toggle="modal" data-bs-target="#searchModal">
                            <i class="fa fa-search header-link-icon"></i>
                        </a>
                        {/* <!-- End::header-link --> */}
                    </div>
                    {/* <!-- End::header-element --> */}
                    ...
                    <div class="header-element country-selector d-none">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                            <img src={flag} alt="img" class="rounded-circle" />
                        </a>
                    ...
                    <div class="header-element cart-dropdown d-none">
                        {/* <!-- Start::header-link|dropdown-toggle --> */}
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                            <i class="fa fa-shopping-cart header-link-icon"></i>
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                            ...
                            <div class="p-3 empty-header-item border-top d-flex">
                                <a href="checkout.html" class="btn btn-primary btn-pill w-sm btn-sm  fs-16"><i class="fa fa-check-circle me-2 d-inline-flex"></i>checkout</a>
                    ...
                    <div class="header-element notifications-dropdown" >
                        ...
                        <a aria-label="anchor" href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" id="messageDropdown" aria-expanded="false">
                            <i class="fa fa-bell header-link-icon"></i>
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                            ...
                            <ul class="list-unstyled mb-0" id="header-notification-scroll">
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start">
                                         <div class="pe-2">
                                             <span class="avatar avatar-md bg-primary avatar-rounded"><i class="fa fa-mail fs-18"></i></span>
                                         </div>
                                         <div class="flex-grow-1 d-flex align-items-center my-auto">
                                            <div>
                                                <p class="mb-0 fw-semibold"><Link to='/'>New Application received</Link></p>
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start">
                                         <div class="pe-2">
                                             <span class="avatar avatar-md bg-secondary avatar-rounded"><i class="fa fa-check-circle fs-18"></i></span>
                                         </div>
                                         <div class="flex-grow-1 d-flex align-items-center my-auto">
                                            <div>
                                                <p class="mb-0 fw-semibold"><Link to='/'>Project has been approved</Link></p>
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start">
                                         <div class="pe-2">
                                             <span class="avatar avatar-md bg-success avatar-rounded"><i class="fa fa-shopping-cart fs-18"></i></span>
                                         </div>
                                         <div class="flex-grow-1 d-flex align-items-center my-auto">
                                            <div>
                                                <p class="mb-0 fw-semibold"><Link to='/'>Your Product Delivered</Link></p>
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start">
                                         <div class="pe-2">
                                             <span class="avatar avatar-md bg-pink avatar-rounded"><i class="fa fa-shopping-cart fs-18"></i></span>
                                         </div>
                                         <div class="flex-grow-1 d-flex align-items-center my-auto">
                                            <div>
                                                <p class="mb-0 fw-semibold"><Link to='/'>Friend Requests</Link></p>
                            ...
                            <div class="p-3 empty-header-item1 border-top text-center">
                                <Link to='/' class="">View All Notifications</Link>
                            </div>
                    ...
                    <div class="header-element message-dropdown">
                        ...
                        <a aria-label="anchor" href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" id="messageDropdown2" aria-expanded="false">
                            <i class="fa-solid fa-envelope header-link-icon"></i>
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                            ...
                            <ul class="list-unstyled mb-0" id="header-message-scroll">
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start">
                                         <div class="pe-2">
                                            <img src={profile} alt="img" class="avatar avatar-md avatar-rounded" />
                                         </div>
                                         <div class="w-100">
                                            <div class="flex-grow-1 d-flex align-items-centermy-auto">
                                                <div>
                                                    <h6 class="mb-0 fw-semibold fs-14"><Link to='/'>Shannon Shaw</Link></h6>
                                                </div>
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start">
                                         ...
                                         <div class="w-100">
                                            <div class="flex-grow-1 d-flex align-items-centermy-auto">
                                                <div>
                                                    <h6 class="mb-0 fw-semibold fs-14"><Link to='/'>Cherry Blossom</Link></h6>
                                                </div>
                                                <div class="ms-auto text-end">
                                                    <p class="text-muted mb-0">7:55pm</p>
                                                </div>
                            ...
                            <div class="p-3 empty-header-item2 border-top text-center">
                                <Link to='/' class="">View All Messages</Link>
                            </div>
                    ...
                    {/* <!-- Start::header-element --> */}
                    <div class="header-element header-fullscreen d-none">
                        {/* <!-- Start::header-link --> */}
                        <a aria-label="anchor" onclick="openFullscreen();" href="#" class="header-link">
                            <i class="fa fa-minimize full-screen-open header-link-icon"></i>
                            <i class="fa fa-minimize-2 full-screen-close header-link-icon d-none"></i>
                        </a>
                        {/* <!-- End::header-link --> */}
                    </div>
                    {/* <!-- End::header-element --> */}
                    ...
                    <div class="header-element d-none">
                        ...
                        <a aria-label="anchor" href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="offcanvas" data-bs-target="#sidebar-right">
                            <i class="fa fa-align-right header-link-icon"></i>
                        </a>
                        {/* <!-- End::header-link|dropdown-toggle --> */}
                    </div>
                    {/* <!-- End::header-element --> */}
                    ...
                    <div class="header-element main-profile-user">
                        ...
                        <a href="#" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                <div class="me-xxl-2 me-0">
                                    <img src={profile} alt="img" width="32" height="32" class="rounded-circle" />
                                </div>
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                            ...
                            <li class="dropdown-item"><Link class="d-flex w-100" to='/profile'><i class="fa fa-user fs-18 me-2 text-primary"></i>Profile</Link></li>
                            <li class="dropdown-item"><Link class="d-flex w-100" to='/'><i class="fa fa-mail fs-18 me-2 text-primary"></i>Inbox <span class="badge bg-danger ms-auto">25</span></Link></li>
                            <li class="dropdown-item"><Link class="d-flex w-100" to='/'><i class="fa fa-settings fs-18 me-2 text-primary"></i>Settings</Link></li>
                            <li class="dropdown-item"><Link class="d-flex w-100" to='/'><i class="fa fa-headphones fs-18 me-2 text-primary"></i>Support</Link></li>
                            <li class="dropdown-item"><Link class="d-flex w-100" to='/'><i class="fa fa-lock fs-18 me-2 text-primary"></i>Lockscreen</Link></li>
                            <li class="dropdown-item"><Link class="d-flex w-100" to='/'><i class="fa fa-info fs-18 me-2 text-primary"></i>Log Out</Link></li>
                        </ul>
                    </div>
                    {/* <!-- End::header-element --> */}
